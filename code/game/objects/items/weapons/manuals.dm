...
/obj/item/weapon/book/manual/games
	...
	dat = {"<html>
        ...
        h3 {font-size: 15px; margin: 15px 0px 5px;}
				...
				Repeat the cycle until a player reaches <b>5</b> points, then they win! The winner decides who starts rolling first in the next game and can give/receive a dare from one other player of their choice.
				<h3>Ties</h3>
